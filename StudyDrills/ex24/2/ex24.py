...
def secret_formula(started):
    ...
    crates = jars / 100
    return   jars, crates # not enough variable to unpack


start_point = 10000
jars, crates = secret_formula(start_point) # not enough variable to unpack

# Remeber that this is another way to format a string
print("With the starting point of: {}".format(start_point))
# it's just like with an f"" string
print(f"We'd have {jars} jars, and {crates} crates.")
